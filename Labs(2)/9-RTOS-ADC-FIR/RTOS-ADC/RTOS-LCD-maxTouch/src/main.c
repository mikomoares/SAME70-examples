...
#define BLOCK_SIZE 1   // se ser? processado por blocos, no caso n?o.
...
#define TASK_ACD_STACK_SIZE            (4*1024/sizeof(portSTACK_TYPE))
#define TASK_ACD_STACK_PRIORITY        (tskIDLE_PRIORITY)
...
int main(void){
  ...
  if (xTaskCreate(task_adc, "adc", TASK_ACD_STACK_SIZE, NULL, TASK_ACD_STACK_PRIORITY, NULL) != pdPASS) {
